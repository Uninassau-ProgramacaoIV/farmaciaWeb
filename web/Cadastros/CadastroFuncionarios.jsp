<%-- 
    Document   : CadastroFuncionarios
    Created on : 22/11/2014, 10:21:51
    Author     : Filipe
--%>
    ...
    <body>
     <div class="panel panel-primary">
		<div class="panel-heading">
			<center class="panel-title">Cadastro de Funcionario</center>
		</div>
		<div class="panel-body">
			<div class="ajustar-grid">
				<form class="form-horizontal" role="form" method="POST" action="../CadastrarFuncionarioController">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="idadeID"
								placeholder="Sobrenome" name="idadeID">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="tel" class="form-control.melhora" id="telefoneID"
								placeholder="Numero do Telefone" name="telefoneID" />
                                    ...
                                    <div class="form-group">
						<label for="setorID" class="col-sm-2 control-label">Login:</label>
						<div class="col-sm-10">
							<input type="text" class="form-control.melhora" id="loginID"
								placeholder="Digite seu login" name="loginID" />
						</div>
					</div>
					<div class="form-group">
						<label for="setorID" class="col-sm-2 control-label">Setor:</label>
						<div class="col-sm-10">
							<input type="password" class="form-control.melhora" id="setorID"
								placeholder="Digite seu setor" name="setorID" />
						</div>
					</div>
					<div class="form-group">
						<label for="telefoneID" class="col-sm-2 control-label">Senha:</label>
						<div class="col-sm-10">
							<input type="password" class="form-control.melhora"
								id="passwordID" placeholder="Digite sua senha	" name="passwordID"/>
						</div>
					</div>
					<div class="form-group">
